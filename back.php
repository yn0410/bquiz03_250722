...
<div id="main">
  ...
  </div>  <div id="text"> <span class="ct">最新活動</span>
  ...
  <div id="mm">
    ...
    <?php if(isset($_SESSION['admin'])): ?>
        <div class="ct a rb" style="position:relative; width:101.5%; left:-1%; padding:3px; top:-9px;">
            <a href="?do=admin&redo=title">網站標題管理</a>|
            <a href="?do=admin&redo=ad">動態文字管理</a>|
            <a href="?do=admin&redo=poster">預告片海報管理</a>|
            <a href="?do=admin&redo=movie">院線片管理</a>|
